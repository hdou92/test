...
import com.hd.test.elastic.modules.entity.ElasticUserModel;
...
public class ElasticUserModelService extends ElasticServiceBase<ElasticUserModel> {
    ...
    public ElasticUserModelService(ElasticManager elasticManager) {
        super(ElasticIndexConsts.SOURCE_ROBOT_STATUS_INDEX_NAME, ElasticUserModel.class, elasticManager);
    }
