...
import com.hd.test.common.CharsetEnum;
...
//        Object val = redisUtil.hget(key, hashKey);
//        if (val != null) {
//            return ZJsonUtils.fromJsonEx(val.toString(), clazz);
//        }
//        return null;
...
//        return redisUtil.hset(key, hashKey, ZJsonUtils.toJsonEx(hashVal));
...
//        Object val = lGetIndex(key, index);
//        if (val != null) {
//            return ZJsonUtils.fromJsonEx(val.toString(), clazz);
//        }
//        return null;
...
//        return lPush(key, ZJsonUtils.toJsonEx(val));
...
//        return redisTemplate.opsForList().leftPush(key, ZJsonUtils.toJsonEx(val));
        return redisTemplate.opsForList().leftPush(key, val);
    }
    ...
    public String lock(String key, int waitExpiry, int keyExpiry) throws UnsupportedEncodingException {
        ...
        String utf8 = CharsetEnum.UTF8.value();
