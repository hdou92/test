...
public class MyGenericJackson2JsonRedisSerializer implements RedisSerializer<Object> {
    ...
    /**
     * Creates {@link MyGenericJackson2JsonRedisSerializer} and configures {@link ObjectMapper} for default typing.
     */
    ...
    /**
     * Creates {@link MyGenericJackson2JsonRedisSerializer} and configures {@link ObjectMapper} for default typing using the
    ...
    public MyGenericJackson2JsonRedisSerializer(@Nullable String classPropertyTypeName) {
        ...
        mapper.registerModule(new SimpleModule().addSerializer(new MyGenericJackson2JsonRedisSerializer.NullValueSerializer(classPropertyTypeName)));
